...
<div class="bground container-fluid">
    <div class="luar col-11 animate__animated animate__bounce animate__backInDown">
        <h1 class="judul container animate__animated animate__bounce animate__fadeInBottomRight">Bidang Pekerjaan</h1>
            ...
            <div class="contentku container-fluid animate__animated animate__bounce animate__fadeInBottomRight">
                <div class="row">
                    <div class="judul-dalam col-12">
                        <h4 class="card-title" style="margin-top: 0.5rem;">Data Bidang Pekerjaan</h4>
                        <div class="card-subtitle" style="margin-top: 0.5rem;">
                            <?= anchor('bidang/tambah', 'Tambah Data', 'class="tambah btn"') ?>
                        </div>
                                ...
                                <tbody>
                                    <?php foreach ($bidang as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="tb-dalam">
                                                <a href="<?= site_url('bidang/ubah/' . $row->id_bidang) ?>" class="ubah btn" title="Ubah">Ubah</a>
                                                <a href="#" data-href="<?php echo site_url('bidang/hapus/' . $row->id_bidang); ?>" data-toggle="modal" data-target="#confirm-delete" class="hapus btn" title="Hapus">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
