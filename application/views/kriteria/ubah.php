      ...
      <div class="container-fluid animate__animated animate__bounce animate__fadeInBottomRight">
        <div class="row">
          <div class="judul-dalam col-12">
            <h4 class="card-title" style="margin-top: 0.5rem;">Ubah Data Kriteria</h4>
            <?= form_open('kriteria/ubah/' . $kriteria->id_kriteria, 'class="form-horizontal form-material animate__animated animate__bounce animate__heartBeat"') ?>
          </div>
        </div><br>
        ...
        <div class="formku container-fluid">
          <div class="row ms-10">
            ...
            <div class="form-data col-10">
              <input type="text" name="kode_kriteria" class="form-control " style="background: transparent; border-color: transparent; border-bottom: 1px solid black; border-radius: 0px;" value="<?= set_value('kode_kriteria', $kriteria->kode_kriteria) ?>">
          ...
          <div class="row">
            <label class="col-md-12 text-black fs-5 ">Kode Kriteria</label>
            <div class="form-data col-10">
              <input type="text" name="nama_kriteria" class="form-control " style="background: transparent; border-color: transparent; border-bottom: 1px solid black; border-radius: 0px;" value="<?= set_value('nama_kriteria', $kriteria->nama_kriteria) ?>">
