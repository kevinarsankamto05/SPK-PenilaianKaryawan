...
<div class="bground container-fluid">
    <div class="luar col-11 animate__animated animate__bounce animate__backInDown">
        ...
        <div class="dalam animate__animated animate__bounce animate__backInUp">
            <div class="contentku row animate__animated animate__bounce animate__fadeInBottomRight">
                <div class=" judul-dalam col-12">
                    <h4 class="card-title animate__animated animate__bounce" style="margin-top: 0.5rem;">Data Kriteria</h4>
                    <div class="card-subtitle">
                        <?= anchor('kriteria/tambah', 'Tambah Data', 'class="tambah btn"') ?>
                        <?= anchor('kriteria/prioritas', 'Prioritas Kriteria', 'class="tambah btn"') ?>
                    </div>
                    <div class="table-responsive col-12">
                        <table class="container-fluid col-12" id="dataTables1">
                            <thead>
                                <tr>
                                    <th class="tb">No</th>
                                    <th class="tb">Kode Kriteria</th>
                                    <th class="tb">Nama Kriteria</th>
                                    <th class="tb">Nilai Prioritas</th>
                                    <th class="tb" width="15%">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($kriteria as $row) : ?>
                                    <tr>
                                        ...
                                        <td class="tb-dalam"><?= $row->prioritas ?></td>
                                        <td class="tb-dalam">
                                            <a href="<?= site_url('kriteria/ubah/' . $row->id_kriteria) ?>" class="ubah btn" title="Ubah">Ubah</a>
                                            <a href="#" data-href="<?php echo site_url('kriteria/hapus/' . $row->id_kriteria); ?>" data-toggle="modal" data-target="#confirm-delete" class="hapus btn" title="Hapus">Hapus</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
