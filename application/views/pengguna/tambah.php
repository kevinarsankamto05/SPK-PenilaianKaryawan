...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="judul-signup col-3 offset-8" style="position: absolute; top : 100px; margin-right: 100px;">
                <p class="fs-1 col animate__animated animate__bounce animate__rubberBand">Create Account</p>
            </div>
        </div>
        <form class="col-4 offset-7" style="position: absolute; top:190px">
            <?= form_open('pengguna/tambah', 'class="form-horizontal form-material"') ?>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label animate__animated animate__bounce animate__backInDown">Nama Lengkap</label>
                <input type="text" class="form-control form-control-line animate__animated animate__bounce animate__backInDown" name="username" placeholder="Nama Lengkap" value="<?= set_value('username') ?>">
            ...
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label animate__animated animate__bounce animate__backInDown">Role</label>
                <select name="role" class="form-control form-control-line animate__animated animate__bounce animate__backInDown">
                    <option value="">Pilih...</option>
                    <option value="Admin" <?= set_select('role', 'Admin') ?>>Admin</option>
                    <option value="Pimpinan" <?= set_select('role', 'Pimpinan') ?>>Pimpinan</option>
                </select>
            ...
            <button type="submit" name="save" class="btn-login col-12 btn animate__animated animate__bounce animate__rotateInUpRight">Create Account</button>
            <?= form_close(); ?>
        </form>
