            ...
            <div class="contentku container-fluid animate__animated animate__bounce animate__fadeInBottomRight">
                <div class="row">
                    <div class="judul-dalam col-12">
                        <h4 class="card-title" style="margin-top: 0.5rem;">Data Nilai</h4>
                        <div class="card-subtitle" style="margin-top: 0.5rem;">
                            <?= anchor('nilai/tambah', 'Tambah Data', 'class="tambah btn"') ?>
                            <?= anchor('nilai/prioritas', 'Prioritas Nilai', 'class="tambah btn"') ?>
                        </div>
                                ...
                                <tbody>
                                    <?php foreach ($nilai as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="tb-dalam"><?= $row->batas_1 . ' - ' . $row->batas_2 ?></td>
                                            <td class="tb-dalam"><?= $row->nama ?></td>
                                            <td class="tb-dalam"><?= $row->prioritas ?></td>
                                            <td class="tb-dalam">
                                                <a href="<?= site_url('nilai/ubah/' . $row->id_nilai) ?>" class="ubah btn" title="Ubah">Ubah</a>
                                                <a href="#" data-href="<?php echo site_url('nilai/hapus/' . $row->id_nilai); ?>" data-toggle="modal" data-target="#confirm-delete" class="hapus btn" title="Hapus">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn hapus btn-ok">Hapus</a>
            </div>
        </div>
    </div>
</div>
