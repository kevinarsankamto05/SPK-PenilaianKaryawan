            ...
            <div class="container-fluid animate__animated animate__bounce animate__zoomIn">
                <div class="row">
                    <div class="judul-dalam col-12">
                        <h4 class="card-title" style="margin-top: 0.5rem;">Tambah Nilai</h4>
                        <?= form_open('nilai/tambah', 'class="form-horizontal form-material"') ?>
                    </div>
                </div><br>
                <div class="formku container-fluid">
                    <div class="row ms-10">
                        <label class="col-md-12 text-black fs-5">Rentang Nilai</label>
                        <div class="form-data col-10">
                            <div class="input-group col-8">
                                <input type="text" name="batas_1" placeholder="Nilai batas 1" class="form-control form-control-line" style="background: transparent; border-color: transparent; border-bottom: 1px solid black; border-radius: 0px;" value="<?= set_value('batas_1') ?>">
                                <input type="text" name="batas_2" placeholder="Nilai batas 2" class="form-control form-control-line" style="background: transparent; border-color: transparent; border-bottom: 1px solid black; border-radius: 0px;" value="<?= set_value('batas_2') ?>">
                            </div>
                    ...
                    <div class="row">
                        <label class="col-md-12 text-black fs-5">Rentang Nilai</label>
                        <div class="form-data col-10">
                            <input type="text" name="nama" class="form-control form-control-line" style="background: transparent; border-color: transparent; border-bottom: 1px solid black; border-radius: 0px;" value="<?= set_value('nama') ?>">
