...
<div class="bground container-fluid">
    <div class="luar col-11 animate__animated animate__bounce animate__backInDown">
        <h1 class="judul container animate__animated animate__bounce animate__zoomIn">Tambah Periode Penilaian</h1>
            ...
            <div class="container-fluid animate__animated animate__bounce animate__zoomIn">
                <div class="row">
                    <div class="judul-dalam col-12">
                        <h4 class="card-title" style="margin-top: 0.5rem;">Tambah Periode Penilaian</h4>
                        <?= form_open('periode/tambah', 'class="form-horizontal form-material"') ?>
                    </div>
                    ...
                    <div class="formku">
                        <div class="row ms-10">
                            ...
                            <div class="form-data col-10">
                                <input type="text" name="periode_penilaian" class="form-control form-control-line" style="background: transparent; border-color: transparent; border-bottom: 1px solid black; border-radius: 0px;" value="<?= set_value('periode_penilaian') ?>">
                        ...
                        <div class="tombol">
                            <div class="col-sm-12">
                                ...
                                <?= anchor('periode', 'Kembali', 'class="kembali btn"') ?>
                            </div>
                        </div>
                    </div>
                    <?= form_close(); ?>
